...
urlpatterns = [
    ...
    # path("zerorisk_score/", views.zerorisk_page, name="zerorisk_score"),
    # path("ai/full-stock-analysis/", views.ai_full_stock_analysis,name="ai_full_stock_analysis"),

    path("aiml_summary/", views.aiml_summary_page, name="aiml_summary_page"),
    path("ai/ml-summary/", views.ai_ml_summary, name="ai_ml_summary"),

    path("ai/news-summary/", views.ai_news_summary, name="ai_news_summary"),
    path("sentiment/run/", views.run_sentiment, name="run_sentiment"),
    path("news_dashboard/", views.sentiment_dashboard, name="news_dashboard"),
